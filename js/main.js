...
function editImage() {
    ...
    let brightValShow = document.querySelector('#brightness-range');
    let blurValShow = document.querySelector('#blur-range');
    let hueValShow = document.querySelector('#hue-range');
    let greyValShow = document.querySelector('#greyscale-range')
    let saturationValShow = document.querySelector('#saturation-range');
